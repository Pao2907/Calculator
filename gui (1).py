...
leftparen = Button(root, justify="center",text="(", width=8, pady=10, relief=FLAT, fg="White",font=("Helvetica", "9"), bg="#33434c",activebackground='Gray')
rightparen = Button(root, justify="center",text=")", width=8, pady=10, relief=FLAT, fg="White",font=("Helvetica", "9"), bg="#33434c",activebackground='Gray')
...
leftparen.grid(row=1, column=1,padx=3, pady=3)
rightparen.grid(row=1, column=2,padx=3, pady=3)
